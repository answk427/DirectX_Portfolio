...
namespace Vertex
{
	...
	struct Basic32
	{
		Basic32() : Pos(0, 0, 0), Normal(0, 0, 0), Tex(0, 0) {}
		Basic32(XMFLOAT3& pos) : Pos(pos) ,Normal(0, 0, 0), Tex(0, 0) {}
		XMFLOAT3 Pos;
		XMFLOAT3 Normal;
		XMFLOAT2 Tex;
	};
...
public:
	...
	static const D3D11_INPUT_ELEMENT_DESC Basic32SkinnedInstancing[15];
};
